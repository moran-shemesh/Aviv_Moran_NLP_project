...
st.selectbox("What do you think about the summarization?",  ['Bad', 'Good', 'Excellent'], index=0, format_func=special_internal_function, key=None, help=None, on_change=None, args=None, kwargs=None, *, disabled=False)
