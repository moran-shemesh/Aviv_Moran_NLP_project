...
def test_local_bart_summary():
    abs_model_path = f'{pathlib.Path().resolve()}\\model\\ft_cnndm_export_1_EPOCH_75000.pkl'
...
def main():
    ...
    # result: print about training BART
    # test_bart_train()

    # result: ground-truth summary and generated summary
